    ...
    data: [
      {
        ...
        image: BASE_URL + "images/gears/aburrey-auditory-chip.png",
        ...
        substats: [
          ...
          { text: "Will", value: 15 },
          { text: "DMG Bonus vs. Staggered", value: "29.40%" },
        ],
        setId: GearSetIds.AburreysLegacy,
      },
      {
        id: GearIds.AburreyAuditoryChipT1,
        image: BASE_URL + "images/gears/aburrey-auditory-chip-t1.png",
      ...
      },
      {
        ...
        image: BASE_URL + "images/gears/aburrey-sensor-chip.png",
      ...
      },
      {
        ...
        image: BASE_URL + "images/gears/catastrophe-gauze-cartridge.png",
        ...
        substats: [
          { text: "Strength", value: 23 },
          { text: "Intellect", value: 15 },
          { text: "Ultimate DMG Bonus", value: "36.80%" },
        ],
        setId: GearSetIds.Catastrophe,
      },
      {
        id: GearIds.CatastropheGauzeCartridgeT1,
        image: BASE_URL + "images/gears/catastrophe-gauze-cartridge-t1.png",
        ...
        substats: [
          { text: "Strength", value: 23 },
          { text: "Will", value: 15 },
          { text: "Secondary Attribute", value: "14.70%" },
        ],
        setId: GearSetIds.Catastrophe,
      },
      {
      ...
      },
      {
        ...
        image: BASE_URL + "images/gears/miner-armor-t1.png",
        name: "Miner Armor T1",
        typeId: GearTypeIds.Armor,
        level: 50,
        rarity: "purple",
